...
% Sections formatting
\titleformat{\section}{
  \titlerule\vspace{10pt}\scshape\raggedright\large
}{}{0em}{}[\color{black}]
...
\begin{minipage}[t]{0.3\textwidth}
  \section{contacts}
  {
    \href{tel:989395536558}{\faIcon{mobile-alt} ~~(+98) 939-553-6558} \\ \vspace{6pt}  
    \href{mailto:me@itsloop.dev}{\faIcon{envelope} ~~me@itsloop.dev} \\ \vspace{6pt} 
    \href{https://github.com/itzloop}{\faIcon{github-square} ~~github.com/itzloop}\\ \vspace{6pt} 
    \href{https://linkedin.com/in/sina-shabaniku}{\faIcon{linkedin} ~~linkedin.com/sina-shabaniku} \\ \vspace{6pt} 
    \faIcon{map-marker-alt} ~~Teheran, IRAN
    \vspace*{14pt}
  }
